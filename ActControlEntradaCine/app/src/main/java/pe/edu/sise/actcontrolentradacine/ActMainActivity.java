    ...
    public void validarIngreso(View view){
        ...
        if(edad<18){
            ...
            if(chkDocAutorizacion.isChecked()){
                ...
                Toast.makeText(this, "Requiere un documento de autorización o boleto", Toast.LENGTH_SHORT).show();
            }
        }else{
            if(chkDni.isChecked()){
                Toast.makeText(this, "Puede ingresar", Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(this, "Requiere DNI o boleto", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
